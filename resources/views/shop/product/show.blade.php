						...
						<script>
							$(function(){
								...
								let userName = $(this).parent().find('.user_name').text();
									...
									$(this).parent().parent().append(`<form action="{{route('comments.add', [app()->getLocale(), $product])}}" method="POST" id="new_comment" style="margin: 16px auto; border: 1px solid #333; padding: 16px;">
  								@csrf
