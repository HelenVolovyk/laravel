	...
	@include('inc.breadcrumb')
		...
		<h2 style="color: var(--title);">{{ __('ABOUT') }}</h2>
			<div class="container ">
				<div class="col-md-12  pt-4 pb-5">
					<h4 class="font-italic text-left" style="color: #b8b8b8;">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex, at fuga! Quis molestiae necessitatibus minima recusandae sequi facilis repudiandae nemo commodi eum, culpa est veniam odio quia, cum quam possimus.</h4>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="about__text">
				...
				<p class="text-right pt-5" style="color: #c7a4ca;">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
